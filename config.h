...
static const char col_gray4[]       = "#ff2222";
static const char col_cyan[]        = "#292b2e";
...
static const char *lock_screen[] = {"loginctl", "lock-session", NULL};

static const Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_space,  			spawn,          {.v = roficmd } 	},
	{ MODKEY,                       XK_Return, 			spawn,          {.v = termcmd } 	},
	{ MODKEY,                       XK_d,      			spawn,          {.v = thunarcmd } 	},
	...
	{ MODKEY,			XK_o,				spawn,		{.v = lock_screen}	},
